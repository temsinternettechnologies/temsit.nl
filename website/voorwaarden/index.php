...
<head>
    ...
    <title>Algemene voorwaarden | TEMS Internet Technologies</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-9 mx-auto">
                <div class="container">
                    <h2 class="mb-5">Oh,<br/> Jij bent opzoek naar onze voorwaarden?</h2>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-10 offset-1">
                <div class="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
                    <div class="features-icons-icon d-flex">
                        <i class="icon icon-briefcase m-auto"></i>
                    </div>
                    <h2>Voorwaarden</h2>
                    <hr/>
                    <h4>Aanmelding</h4>
                    ...
                    <br/>
                    <h4>Nieuwsbrief</h4>
                    <p>Wanneer wij het zeer noodzakelijk vinden om nieuws met u te delen zullen wij een nieuwsbrief
                        sturen. dit zal maximaal 2 keer per maand gebeuren en er is altijd de mogelijkeid</p>
                </div>
            </div>
        </div>
    </div>
