...
<body>
<div class="col-lg-6 offset-lg-3 text-center bash">
    <div class="bash-title">
        ...
        <p class="lead" style="display:inline-block; width: 600px; padding:0 100px; text-align: center; color: #000;">tems.exe</p>
    </div>
