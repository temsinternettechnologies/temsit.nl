            ...
            <div class="col-md-12 col-lg-10 col-xl-8 mx-auto">
                <div class="form-row" id="form-bottom">
                    ...
                    <div class="col-12 col-md-12">
                        <p style="font-size: 0.70em">Wij gebruiken uw emailadres enkel tijdens het zoeken van en het
                            onderhouden van contact. wij delen geen gegevens met derde partijen.</p>
                    </div>
                </div>
            </div>
        </div>
